...
## 主包代码水平一般，这个时claude code + deepseekv4制作，功能没问题，欢迎各位大佬批评指正
文件夹里有截图，大家可以看一看
...
[![Version](https://img.shields.io/badge/version-1.2.0-34C759)]()
...
- **Lightroom 风格布局**：底部缩略图条横向滚动、右侧标签面板、可收起侧边栏最大化主图
- **大图浏览**：缩放平移、RGB 直方图、全屏模式、底部星级评分条
...
- **iOS 风格 UI**：浅色主题、毛玻璃效果、SF Symbols 风格图标、柔和阴影
...
### v1.2.0 (2026-06-19)
- 🎞️ 底部缩略图条（Filmstrip），类比 Lightroom 水平排列，滚轮滑动
- 🏷️ 标签面板移至右侧垂直布局，增大主图展示空间
- ⭐ 底部精简为星级评分条，评分/收藏触手可及
- 📂 左侧功能栏可收起（◀/▶），最大化主图视野
- 🎨 全新 PS 风格 "PC" 字母应用图标
- 🧹 移除 Allotment 左右分栏，布局更清爽
